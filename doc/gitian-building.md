...
git clone https://github.com/leisurecoin-crypto/leisurecoin.git
cd leisurecoin
...
```bash
    ...
    From https://github.com/leisurecoin-crypto/leisurecoin
...
For example:
```bash
URL=https://github.com/crowning-/leisurecoin.git
...
[leisurecoin/gitian.sigs](https://github.com/leisurecoin-crypto/gitian.sigs/) repository, or if that's not possible to create a pull
request.
