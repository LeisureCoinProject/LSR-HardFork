...
COIN_REPO='https://github.com/Liquid369/leisurecoin'
COIN_TGZ='https://github.com/leisurecoin/leisurecoin/releases/download/4.0.0/LeisureCoin-4.0.0-x86_64-linux-gnu.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='LeisureCoin'
COIN_PORT=22644 #Updated Port
RPC_PORT=51473
...
# unzip leisurecoin.zip
#tar xvzf leisurecoin-3.1.0-x86_64-linux-gnu.tar.gz
#apt-get install -y megatools
tar -xzf LeisureCoin-4.0.0-x86_64-linux-gnu.tar.gz
cd LeisureCoin-4.0.0/bin
chmod -R 775 *
cp * $COIN_PATH
cd ..
cd $COIN_PATH
...
function blocks() {
	wget https://github.com/leisurecoin/leisurecoin/raw/master/blocks.sh
	chmod 777 blocks.sh 
	bash blocks.sh
...
function save_key() {
	cd /root/.leisurecoin
	mv /root/.leisurecoin/leisurecoin.conf /root/.leisurecoin/leisurecoin_old.conf
	cp /root/.leisurecoin/leisurecoin_old.conf /root
}

function restore_key() {
	cd /root/.leisurecoin
	rm masternode.conf
	cp /root/leisurecoin_old.conf /root/.leisurecoin
	mv /root/.leisurecoin/leisurecoin_old.conf /root/.leisurecoin/leisurecoin.conf
}
...
function backup() {
	...
	rm -rf blocks-
	rm blocks.sh
	zip -r backupdg.zip /root/.leisurecoin
	cp /root/.leisurecoin/backupdg.zip /root
...
function prepare_system() {
 cd ~
   wget https://gist.githubusercontent.com/Liquid369/eca7f89b6c4e63f9b328d92a4f508626/raw/ba14590e3f600acdf8683eeb16cc8b2f9c8fb23e/lsr.txt
#  wget https://gist.githubusercontent.com/hoserdude/9661c9cdc4b59cf5f001/raw/5972d4d838691c1a1f33fb274f97fa0b403d10bd/doge.txt
  cat lsr.txt
printf "%s\n"
echo "LeisureCoin MN installer Depends Starting"
