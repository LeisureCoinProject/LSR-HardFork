...
#ifndef leisurecoin_zlsrTRACKER_H
#define leisurecoin_zlsrTRACKER_H
...
public:
    CzlsrTracker(std::string strWalletFile);
    ~CzlsrTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzlsrWallet* zlsrWallet = NULL);
...
#endif //leisurecoin_zlsrTRACKER_H
