...
#ifndef leisurecoin_zlsrWALLET_H
#define leisurecoin_zlsrWALLET_H
...
public:
    CzlsrWallet(std::string strWalletFile);
    ...
    void GenerateDeterministiczlsr(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedTozlsr(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //leisurecoin_zlsrWALLET_H
