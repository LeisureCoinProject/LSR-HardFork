...
extern UniValue setzlsrseed(const UniValue& params, bool fHelp);
extern UniValue getzlsrseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzlsr(const UniValue& params, bool fHelp);
extern UniValue dzlsrstate(const UniValue& params, bool fHelp);
