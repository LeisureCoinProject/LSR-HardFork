...
public:
    ...
    void setzlsrControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzlsr_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzlsr_clicked();
    void on_pushButtonzlsrControl_clicked();
