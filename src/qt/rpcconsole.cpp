                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzlsrPathCustom = GetArg("-zlsrbackuppath", "");
    ...
    if(!strzlsrPathCustom.empty()) {
        ui->wallet_customzlsrbackuppath->setText(QString::fromStdString(strzlsrPathCustom));
        ui->wallet_customzlsrbackuppath_label->setVisible(true);
        ui->wallet_customzlsrbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzlsrPathCustom.empty()) && nCustomBackupThreshold > 0) {
