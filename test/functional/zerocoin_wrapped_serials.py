...
from fake_stake.base_test import leisurecoin_FakeStakeTest

class zlsrwrappedSerialsTest(leisurecoin_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zlsrs..." % DENOM_TO_USE)
